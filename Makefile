...
PAIVOT_SKILLS := anchor architect architect_challenger ba_challenger business_analyst c4 designer designer_challenger developer domain_model intake nd orchestrator pm_acceptor pvg retro sr_pm vault_capture vault_evolve vault_knowledge vault_settings vault_status vault_triage vlt
...
verify: ## Run delivery proof preflight for a story (usage: make verify STORY=PROJ-a1b2)
	...
	@pvg story verify-delivery "$(STORY)"
